...
namespace Ink.UnityIntegration
{
    ...
    public sealed class InkMetaFile
    {
        ...
        public bool hasCompileErrors { get { return compileErrors.Count > 0; } }
        ...
        public DateTime lastEditDate { get { return File.GetLastWriteTime(inkFile.absoluteFilePath); } }
        ...
        public bool isParent { get { return includes.Count > 0; } }
        ...
        public InkFile masterInkFileIncludingSelf { get { return isMaster ? inkFile : masterInkFile; } }

        // Is this ink file a master file?
        public bool isMaster { get { return masterInkAsset == null; } }
