...
namespace Ink.Runtime
{
    ...
    {
        internal delegate void VariableChanged(string variableName, Object newValue);
        ...
        internal CallStack callStack { get { return _callStack; } set { _callStack = value; } }
        ...
        public object this[string variableName]
        {
            get
            {
                ...
                if (_globalVariables.TryGetValue(variableName, out varContents) || _defaultGlobalVariables.TryGetValue(variableName, out varContents))
        ...
        {
            get { return Json.DictionaryRuntimeObjsToJObject(_globalVariables); }
            set { _globalVariables = Json.JObjectToDictionaryRuntimeObjs(value); }
        }

        internal Object GetVariableWithName(string name)
        {
            return GetVariableWithName(name, -1);
        }

        internal Object TryGetDefaultVariableValue(string name)
        {
            Object val = null;
        ...
        internal Object ValueAtVariablePointer(VariablePointerValue pointer)
        {
            return GetVariableWithName(pointer.variableName, pointer.contextIndex);
        }

        internal void Assign(VariableAssignment varAss, Object value)
        {
        ...
        internal void SetGlobal(string variableName, Object value)
        {
