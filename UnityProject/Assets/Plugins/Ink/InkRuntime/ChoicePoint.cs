namespace Ink.Runtime
{
    ...
    /// </summary>
    internal class ChoicePoint : Object
    {
        ...
        internal Container choiceTarget { get { return this.ResolvePath(_pathOnChoice).container; } }

        internal string pathStringOnChoice { get { return CompactPathString(pathOnChoice); } set { pathOnChoice = new Path(value); } }
