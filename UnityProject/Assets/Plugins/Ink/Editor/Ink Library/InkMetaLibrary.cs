...
namespace Ink.UnityIntegration
{
    ...
    {
        public static bool created { get { return _Instance != null || FindLibrary() != null; } }
        ...
        public static string pathPlayerPrefsKey { get { return pathPlayerPrefsKeyPrefix + " " + Application.productName; } }
        ...
        private static InkMetaLibrary FindOrCreateLibrary()
        {
            ...
            else
            {
                ...
                if (!valid)
                {
                    ...
                    Debug.LogWarning(
                        "Ink Meta Library data corrupted. This can happen when Unity updates its library. Updated file connections but recommend recompiling.");
                }
            }
...
//					metaFile.inkAsset = null;
                    ...
                    if (metaFile.inkAsset == null)
                    {
                        ...
                        Debug.LogWarning("Ink file for asset " + AssetDatabase.GetAssetPath(metaFile.inkAsset) + " was not found. Path was " +
                                         metaFile.inkAssetPath);
                    }
                }
                ...
                if (metaFile.masterInkAsset != null && metaFile.masterInkFile == null)
                {
                    ...
                    {
                        foundDiscrepancy = true;
                        Debug.LogWarning("Ink file for master asset " + AssetDatabase.GetAssetPath(metaFile.masterInkAsset) + " was not found. Path was " +
                                         metaFile.masterInkAssetPath);
                    }
                }
            }
