...
namespace Ink.Runtime
{
    ...
    public class StoryState
    {
        ...
        internal int callstackDepth { get { return callStack.depth; } }

        // REMEMBER! REMEMBER! REMEMBER!
        // When adding state, update the Copy method, and serialisation.
        // REMEMBER! REMEMBER! REMEMBER!

        internal List<Object> outputStream { get { return _outputStream; } }
        ...
        internal List<Choice> generatedChoices { get { return _currentChoices; } }
        ...
        internal List<Object> evaluationStack { get; private set; }
        ...
        internal Pointer currentPointer
        {
            get { return callStack.currentElement.currentPointer; }
            set { callStack.currentElement.currentPointer = value; }
        }

        internal Pointer previousPointer { get { return callStack.currentThread.previousPointer; } set { callStack.currentThread.previousPointer = value; } }

        internal bool canContinue { get { return !currentPointer.isNull && !hasError; } }

        internal bool hasError { get { return currentErrors != null && currentErrors.Count > 0; } }

        internal bool hasWarning { get { return currentWarnings != null && currentWarnings.Count > 0; } }
        ...
        {
            get { return callStack.currentElement.inExpressionEvaluation; }
        ...
        public Dictionary<string, object> jsonToken
        {
            ...
            set
            {
                ...
                {
                    throw new StoryException("Ink save format isn't compatible with the current version (saw '" + jSaveVersion + "', but minimum is " +
                                             kMinCompatibleLoadVersion + "), so can't load.");
                }
        ...
        internal void ResetOutput(List<Object> objs = null)
        {
            _outputStream.Clear();
        ...
        internal void PushToOutputStream(Object obj)
        {
        ...
        internal void PushEvaluationStack(Object obj)
        {
        ...
        internal Object PopEvaluationStack()
        {
        ...
        internal Object PeekEvaluationStack()
        {
            return evaluationStack[evaluationStack.Count - 1];
        }

        internal List<Object> PopEvaluationStack(int numberOfObjects)
        {
