...
namespace Ink.Runtime
{
    internal class CallStack
    {
                ...
                foreach (object jElTok in jThreadCallstack)
                {
                    ...
                    if (jElementObj.TryGetValue("cPath", out currentContainerPathStrToken))
                    {
                        ...
                        if (threadPointerResult.obj == null)
                            throw new Exception("When loading state, internal story location couldn't be found: " + currentContainerPathStr +
                                                       ". Has the story changed since this save data was created?");
                        else if (threadPointerResult.approximate)
                            storyContext.Warning("When loading state, exact internal story location couldn't be found: '" + currentContainerPathStr +
                                                 "', so it was approximated to '" + pointer.container.path.ToString() +
        ...
        public List<Element> elements { get { return callStack; } }

        public int depth { get { return elements.Count; } }
        ...
        public int currentElementIndex { get { return callStack.Count - 1; } }

        public Thread currentThread
        {
            get { return _threads[_threads.Count - 1]; }
            set
            {
        ...
        public bool canPop { get { return callStack.Count > 1; } }
        ...
        public bool canPopThread { get { return _threads.Count > 1 && !elementIsEvaluateFromGame; } }

        public bool elementIsEvaluateFromGame { get { return currentElement.type == PushPopType.FunctionEvaluationFromGame; } }
        ...
        public void Push(PushPopType type, int externalEvaluationStackHeight = 0, int outputStreamLengthWithPushed = 0)
        {
            ...
            var element = new Element(type, currentElement.currentPointer, inExpressionEvaluation: false);
        ...
        private List<Element> callStack { get { return currentThread.callstack; } }
