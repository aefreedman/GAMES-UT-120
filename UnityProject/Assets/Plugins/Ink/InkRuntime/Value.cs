...
namespace Ink.Runtime
{
    ...
    internal abstract class Value : Object
    {
    ...
    internal abstract class Value<T> : Value
    {
        ...
        public override object valueObject { get { return (object) value; } }
    ...
    internal class FloatValue : Value<float>
    {
        ...
        public override Value Cast(ValueType newType)
        {
            ...
            if (newType == ValueType.String)
            {
                return new StringValue("" + this.value.ToString(CultureInfo.InvariantCulture));
            }
    ...
    internal class StringValue : Value<string>
    {
        ...
        public bool isNonWhitespace { get { return !isNewline && !isInlineWhitespace; } }
    ...
    {
        public override ValueType valueType { get { return ValueType.List; } }
        ...
        public ListValue(InkListItem singleItem, int singleValue)
            : base(null)
        {
            value = new InkList { { singleItem, singleValue } };
        }
