...
namespace Ink.Runtime
{
    ...
    public struct InkListItem
    {
        ...
        internal static InkListItem Null { get { return new InkListItem(null, null); } }

        internal bool isNull { get { return originName == null && itemName == null; } }

        /// <summary>
        /// Get the full dot-separated name of the item, in the form "listDefinitionName.itemName".
        /// </summary>
        public string fullName { get { return (originName ?? "?") + "." + itemName; } }
        ...
        public void AddItem(string itemName)
        {
            ...
            foreach (var origin in origins)
            {
                if (origin.ContainsItemWithName(itemName))
                {
                    ...
                    {
                        throw new Exception("Could not add the item " + itemName + " to this list because it could come from either " + origin.name +
                                                   " or " + foundListDef.name);
                    }
                    else
                    {
                        foundListDef = origin;
